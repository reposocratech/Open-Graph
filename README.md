...
# Cómo hacer uso del protocolo Open Graph

## Descripción 
Sergio Jiménez, profesor del Bootcamp Full-Stack Web Developer, nos enseña cómo podemos hacer uso del protocolo Open Graph para tener unas previws enriquecidas al compartir nuestro sitio web por redes sociles, apps de mensajería, etc.

## Vídeo

Toda la explicación está en el siguiente vídeo: [Añade Open Graph a tus páginas web](https://youtu.be/9T0dE66NDag)
